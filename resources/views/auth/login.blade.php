...
<head>
    ...
    <title>SalahSambung - Masuk</title>
...
<body class="bg-[#150D05] min-h-screen font-londrina text-white antialiased flex flex-col items-center justify-center relative overflow-x-hidden py-10 px-4">
    ...
    <div class="relative z-10 w-full max-w-md p-8 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl">
        ...
        <div class="space-y-3">
            <a href="{{ route('google.login') }}" class="w-full bg-white hover:bg-gray-100 text-gray-900 text-lg font-light py-3 rounded-xl transition-colors flex items-center justify-center gap-3">
        ...
        <p class="text-center mt-8 text-white/70 font-light text-lg">
            Belum punya akun? <a href="/daftar" class="text-[#FFB200] hover:underline">Daftar sekarang</a>
        </p>
    </div>
</body>
</html>
