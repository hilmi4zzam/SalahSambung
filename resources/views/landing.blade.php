  ...
  <footer class="bg-gradient-to-b from-[#432613] to-[#27180C] py-10 w-full mt-auto">
    <div class="max-w-[1100px] mx-auto px-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
      ...
      <div class="flex flex-col gap-2 items-start">
        ...
        <a href="https://instagram.com/hilmi4zzam" target="_blank" class="flex items-center gap-3 no-underline text-white font-light text-[16px] md:text-[22px] hover:text-[#C7B09C] transition-colors">
        ...
        <a href="https://github.com/hilmi4zzam" target="_blank" class="flex items-center gap-3 no-underline text-white font-light text-[16px] md:text-[22px] hover:text-[#C7B09C] transition-colors">
